...
if(document.querySelector("#formRegister")){
	...
	formRegister.addEventListener('submit',(e)=>{
        ...
        let strDireccionFiscal = document.querySelector('#txtdireccionFiscal').value;
		
		if(strApellido == '' || strNombre == '' || strEmail == '' || intTelefono == '' || strClave == '' || strNit == '' || intDni == '' || strNombreFiscal == '' || strDireccionFiscal == '')
			{
...
//#endregion final formulario registro
