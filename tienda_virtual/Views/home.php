<?php 
 ...
 ?>
	...
	<section class="bg0 p-t-23 p-b-140">
		...
		<div class="container text-center p-t-80"><hr>
			<div class="p-t-80"> 
				<h3 class="ltext-103 cl5">Nuestras marcas</h3> 
			</div> 
			<div> 
				<p>Distribuimos las mejores marcas</p> 
			</div> 
			<div class="row"> 
				<div class="col-md-3">
					<img src="Assets/images/marca1.png" alt="Marca 1" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca2.png" alt="Marca 2" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca3.png" alt="Marca 3" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca4.png" alt="Marca 4" width="110" height="110" />
				</div> 
			</div><hr>
			<div class="row"> 
				<div class="col-md-3">
					<img src="Assets/images/marca5.png" alt="Marca 5" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca6.png" alt="Marca 6" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca7.png" alt="Marca 7" width="110" height="110" />
				</div> 
				<div class="col-md-3">
					<img src="Assets/images/marca8.png" alt="Marca 8" width="110" height="110" />
				</div> 
			</div>
		</div>
	</section>
